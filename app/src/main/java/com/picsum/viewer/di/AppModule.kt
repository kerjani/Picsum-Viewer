...
import com.picsum.viewer.BuildConfig
import com.picsum.viewer.data.PicsumDatabase
...
object AppModule {
    ...
    fun provideDatabase(@ApplicationContext appContext: Context) =
        PicsumDatabase.getDatabase(appContext)

    @Singleton
    @Provides
    fun provideDao(db: PicsumDatabase) = db.dao()
}